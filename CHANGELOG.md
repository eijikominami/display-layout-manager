...
### Changed
- **メニューバーアイコン**: `⧈` → `⧉` に変更（複数ディスプレイを表現）

## [1.5.2] - 2026-01-10

### Fixed
- **CI**: Codecov v4 で必須となった token パラメータを追加
...
### Fixed
- **メニューバーアイコン表示**: rumps の初期化パラメータを修正してメニューバーアイコン（⧈）が正しく表示されるように修正

## [1.4.1] - 2025-12-07

### Fixed
- **メニューバーアイコン表示**: rumps の `title` パラメータを正しく設定してメニューバーアイコンが表示されるように修正（未解決）
