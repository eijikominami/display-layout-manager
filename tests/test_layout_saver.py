...
def test_find_existing_pattern_by_screen_ids():
    ...
    patterns = [
        ...
        ConfigPattern(
            ...
            screen_ids=["69733B7E-4C7B-8BDB-11A0-C8F9D6A3E2F1", "37D8832A-2D66-02CA-B9F7-8F30A301B230"],
    ...
    found_pattern = saver.find_existing_pattern_by_screen_ids(screen_ids_existing, patterns)
    ...
    found_pattern = saver.find_existing_pattern_by_screen_ids(screen_ids_not_existing, patterns)
    ...
    screen_ids_reversed = ["37D8832A-2D66-02CA-B9F7-8F30A301B230", "69733B7E-4C7B-8BDB-11A0-C8F9D6A3E2F1"]
    found_pattern = saver.find_existing_pattern_by_screen_ids(screen_ids_reversed, patterns)
