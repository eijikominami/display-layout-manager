...
def test_checkbox_toggle():
    ...
    try:
        ...
        if menu_item.state == expected_state:
            ...
            print(f"  ✗ 初期状態が間違っている (expected={expected_state}, actual={menu_item.state})")
            return False
        ...
        if app.auto_launch_manager.is_enabled() and menu_item.state == 1:
            ...
            print(f"  ✗ 有効化失敗 (is_enabled={app.auto_launch_manager.is_enabled()}, state={menu_item.state})")
            return False
        ...
        if not app.auto_launch_manager.is_enabled() and menu_item.state == 0:
            ...
            print(f"  ✗ 無効化失敗 (is_enabled={app.auto_launch_manager.is_enabled()}, state={menu_item.state})")
            return False
