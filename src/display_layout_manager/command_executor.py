...
class CommandExecutor:
    ...
    def _execute_command(self, command: str, timeout: int = 60) -> Tuple[bool, str, str, int]:
        """
        実際のコマンド実行
    ...
    def execute_command_string(self, command: str, pattern_name: str = "Manual Command") -> ExecutionResult:
        """
        コマンド文字列を直接実行
    ...
    def validate_displayplacer_available(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                return False, f"displayplacer コマンドの実行に失敗しました: {result.stderr}"
